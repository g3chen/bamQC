...
```
dockstore workflow convert entry2json --entry github.com/g3chen/bamQC/BamQC:master > Dockstore.json 
vim Dockstore.json
```
Run locally with the Dockstore CLI
```
dockstore workflow launch --entry github.com/g3chen/bamQC/BamQC:master --json Dockstore.json
```
